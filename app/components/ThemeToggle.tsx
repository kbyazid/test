...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative w-10 h-6 bg-gray-300 dark:bg-gray-600 rounded-full p-0.5 transition-colors duration-300 focus:outline-none"
    ...
    >
      ...
      >
        {/* Sun/Moon icons with swap animation */}
        <div className="relative w-3 h-3">
          ...
          {/* Moon icon */}
          <svg
            className={`absolute inset-0 w-3 h-3 text-blue-400 transition-all duration-300 ${
